...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/npr/apis.md
...
- name: NPR One API Reference - Send a donation email to the logged-in user (only
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/npr/localactivationv2donate-email-get-openapi.md
- name: NPR One API Reference - Send a donation email to the logged-in user (only
    on request)
  x-api-slug: localactivationv2donate-email-get
  description: This will send a station-specific donation email to the logged-in user.
