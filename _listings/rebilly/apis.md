...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/apis.md
specificationVersion: "0.14"
apis:
- name: Rebilly - Create an email credential
  x-api-slug: credentialhashesemails-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/credentialhashesemails-post-openapi.md
- name: Rebilly - Retrieve an email credential
  x-api-slug: credentialhashesemailshash-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/credentialhashesemailshash-get-openapi.md
- name: Rebilly - Sends an email with a link containing a token to reset user password
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/forgotpassword-post-openapi.md
- name: Rebilly - Send a test email
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/previewsruleactionssendemail-post-openapi.md
- name: Rebilly - Create a session with email and password
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/signin-post-openapi.md
- name: Rebilly - Creates a new user and sends an email confirmation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/rebilly/signup-post-openapi.md
- name: Rebilly - Create an email credential
  x-api-slug: credentialhashesemails-post
  description: Create an email credential
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/rebilly.png
