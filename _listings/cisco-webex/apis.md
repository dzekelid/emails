...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/cisco-webex/apis.md
...
- name: Webex Teams Admin API - List people (with exact email)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/cisco-webex/people-get-openapi.md
- name: Webex Teams Admin API - List people (with exact email)
  x-api-slug: people-get
  description: |-
    List people in your organization.
