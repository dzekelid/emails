...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/convertapi/apis.md
specificationVersion: "0.14"
apis:
- name: Convert API - Email to Image
  x-api-slug: email2image-post
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/convertapi/email2image-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/convertapi/email2image-post-openapi.md
- name: Convert API - Email to PDF
  x-api-slug: email2pdf-post
  description: The API for converting E-Mail files to PDF files and Images. These
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/convertapi/email2pdf-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/emails/master/_listings/convertapi/email2pdf-post-openapi.md
- name: Convert API - Email to Image
  x-api-slug: email2image-post
  description: The API for converting E-Mail files to PDF files and Images. These
    file formats eml, mbx, msg, oft can be converted to png, jpg, tif.
